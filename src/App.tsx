  ...
  return (
    <div className="min-h-screen bg-[#05050d] text-gray-200 selection:bg-purple-600 selection:text-white font-sans antialiased overflow-x-hidden relative" dir="rtl">
      ...
      <style>{`
        ...
        .page-ship {position:absolute;display:block;opacity:0;transform-origin:center;will-change:transform,opacity;filter:drop-shadow(0 0 10px rgba(103,232,249,.45));animation-duration:var(--ship-duration,24s);animation-timing-function:ease-in-out;animation-iteration-count:infinite;animation-fill-mode:both;contain:paint}
        ...
        .page-ship-1{top:18%;left:8%;--ship-duration:27s;animation-name:page-ship-drift-1;animation-delay:0s}
        .page-ship-2{top:63%;left:18%;--ship-duration:31s;animation-name:page-ship-drift-2;animation-delay:3s}
        .page-ship-3{top:29%;left:62%;--ship-duration:29s;animation-name:page-ship-drift-3;animation-delay:7s}
        .page-ship-4{top:72%;left:72%;--ship-duration:33s;animation-name:page-ship-drift-4;animation-delay:11s}
        .page-ship-5{top:42%;left:36%;--ship-duration:28s;animation-name:page-ship-drift-5;animation-delay:15s}
        .page-ship-6{top:15%;left:76%;--ship-duration:30s;animation-name:page-ship-drift-6;animation-delay:19s}

        @keyframes page-ship-drift-1{0%{opacity:0;transform:translate3d(-30px,20px,0) rotate(-8deg) scale(.72)}10%{opacity:.82}32%{opacity:.95;transform:translate3d(90px,-10px,0) rotate(3deg) scale(.9)}55%{opacity:.9;transform:translate3d(170px,35px,0) rotate(8deg) scale(1)}78%{opacity:.62;transform:translate3d(260px,-20px,0) rotate(2deg) scale(.9)}100%{opacity:0;transform:translate3d(360px,55px,0) rotate(-5deg) scale(.72)}}
        @keyframes page-ship-drift-2{0%{opacity:0;transform:translate3d(40px,40px,0) rotate(12deg) scale(.68)}12%{opacity:.78}35%{opacity:.94;transform:translate3d(-20px,-35px,0) rotate(4deg) scale(.9)}58%{opacity:.9;transform:translate3d(80px,-75px,0) rotate(-8deg) scale(1)}82%{opacity:.6;transform:translate3d(155px,-20px,0) rotate(-15deg) scale(.82)}100%{opacity:0;transform:translate3d(215px,55px,0) rotate(-6deg) scale(.7)}}
        @keyframes page-ship-drift-3{0%{opacity:0;transform:translate3d(35px,-35px,0) rotate(7deg) scale(.7)}9%{opacity:.86}30%{opacity:.95;transform:translate3d(-85px,20px,0) rotate(-4deg) scale(.96)}52%{opacity:.9;transform:translate3d(-155px,75px,0) rotate(-10deg) scale(1)}76%{opacity:.65;transform:translate3d(-75px,125px,0) rotate(-2deg) scale(.86)}100%{opacity:0;transform:translate3d(-190px,190px,0) rotate(8deg) scale(.68)}}
        @keyframes page-ship-drift-4{0%{opacity:0;transform:translate3d(-45px,-30px,0) rotate(-12deg) scale(.7)}11%{opacity:.82}34%{opacity:.96;transform:translate3d(45px,45px,0) rotate(-2deg) scale(.94)}60%{opacity:.9;transform:translate3d(-35px,115px,0) rotate(9deg) scale(1)}83%{opacity:.6;transform:translate3d(-120px,70px,0) rotate(15deg) scale(.82)}100%{opacity:0;transform:translate3d(-190px,150px,0) rotate(5deg) scale(.68)}}
        @keyframes page-ship-drift-5{0%{opacity:0;transform:translate3d(20px,35px,0) rotate(-5deg) scale(.7)}10%{opacity:.8}30%{opacity:.95;transform:translate3d(95px,15px,0) rotate(8deg) scale(.92)}52%{opacity:.92;transform:translate3d(40px,-70px,0) rotate(-3deg) scale(1)}74%{opacity:.66;transform:translate3d(-60px,-25px,0) rotate(-12deg) scale(.88)}100%{opacity:0;transform:translate3d(-145px,-90px,0) rotate(-4deg) scale(.7)}}
        @keyframes page-ship-drift-6{0%{opacity:0;transform:translate3d(-25px,30px,0) rotate(9deg) scale(.7)}12%{opacity:.84}34%{opacity:.95;transform:translate3d(-100px,-45px,0) rotate(1deg) scale(.94)}57%{opacity:.9;transform:translate3d(-20px,-105px,0) rotate(-8deg) scale(1)}80%{opacity:.62;transform:translate3d(95px,-45px,0) rotate(5deg) scale(.84)}100%{opacity:0;transform:translate3d(175px,-125px,0) rotate(12deg) scale(.68)}}
